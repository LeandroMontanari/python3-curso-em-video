...
galera.append(teste[:])  # Adiciona uma cópia da lista "teste" (e não a própria lista) à lista composta "galera"
...
galera.append(teste[:])  # Adiciona novamente uma cópia da lista "teste" (já modificada) à lista composta "galera"
print(galera)  # Exibe [['Gustavo', 40], ['Maria', 22]] (e não [['Maria', 22], ['Maria', 22]])
