...
if pagamento == 1:
    ...
    print('O produto à vista em dinheiro/cheque, com 10% de desconto, fica de R$ {:.2f} por R$ {:.2f}!'.format(produto, valor))
elif pagamento == 2:
    valor = produto - (produto * 5 / 100)
    print('O produto à vista no cartão de crédito, com 5% de desconto, fica de R$ {:.2f} por R$ {:.2f}!'.format(produto, valor))
elif pagamento == 3:
    ...
    if parcelas == 1:
        ...
        valor = produto
        par = valor / parcelas
        print('O produto parcelado em 2x de R$ {:.2f} no cartão de crédito, sem nenhum desconto, continua por R$ {:.2f}!'.format(par, produto))
    elif 2 < parcelas <= 12:
        valor = produto + (produto * 20 / 100)
        par = valor / parcelas
        print('O produto parcelado em {}x de R$ {:.2f} no cartão de crédito, com 20% de juros, fica de R$ {:.2f} por R$ {:.2f}!'.format(parcelas, par, produto, valor))
    else:
